...
type channelCloser struct {
	...
	lastFeeProposal xpcutil.Amount
	...
	priorFeeOffers map[xpcutil.Amount]*lnwire.ClosingSigned
...
func newChannelCloser(cfg chanCloseCfg, deliveryScript []byte,
	...
	return &channelCloser{
		...
		priorFeeOffers:      make(map[xpcutil.Amount]*lnwire.ClosingSigned),
	}
}
...
func (c *channelCloser) proposeCloseSigned(fee xpcutil.Amount) (*lnwire.ClosingSigned, error) {
...
func feeInAcceptableRange(localFee, remoteFee xpcutil.Amount) bool {
...
// offered fee.
func rachetFee(fee xpcutil.Amount, up bool) xpcutil.Amount {
...
func calcCompromiseFee(chanPoint wire.OutPoint,
	ourIdealFee, lastSentFee, remoteFee xpcutil.Amount) xpcutil.Amount {
