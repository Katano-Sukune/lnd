...
type WalletController interface {
	...
	ConfirmedBalance(confs int32) (xpcutil.Amount, error)
	...
	// p2wsh, etc.
	NewAddress(addrType AddressType, change bool) (xpcutil.Address, error)
	...
	LastUnusedAddress(addrType AddressType) (xpcutil.Address, error)

	// IsOurAddress checks if the passed address belongs to this wallet
	IsOurAddress(a xpcutil.Address) bool
