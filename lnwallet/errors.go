...
func ErrChanReserveTooSmall(reserve, dustLimit xpcutil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanReserveTooLarge(reserve,
	maxReserve xpcutil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanTooSmall(chanSize, minChanSize xpcutil.Amount) ReservationError {
	return ReservationError{
