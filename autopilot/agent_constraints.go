...
type AgentConstraints interface {
	...
	ChannelBudget(chans []Channel, balance xpcutil.Amount) (
		xpcutil.Amount, uint32)
...
func NewConstraints(minChanSize, maxChanSize xpcutil.Amount, chanLimit,
...
func (h *agentConstraints) ChannelBudget(channels []Channel,
	funds xpcutil.Amount) (xpcutil.Amount, uint32) {
	...
	var totalChanAllocation xpcutil.Amount
	...
	targetAllocation := xpcutil.Amount(float64(totalFunds) * h.allocation)
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MinChanSize() xpcutil.Amount {
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MaxChanSize() xpcutil.Amount {
