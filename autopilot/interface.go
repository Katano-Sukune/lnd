...
type ChannelController interface {
	...
	// broadcast.
	OpenChannel(target *btcec.PublicKey, amt xpcutil.Amount) error
	...
	// should be returned.
	SpliceIn(chanPoint *wire.OutPoint, amt xpcutil.Amount) (*Channel, error)
	...
	SpliceOut(chanPoint *wire.OutPoint, amt xpcutil.Amount) (*Channel, error)
}
