...
import (
	...
	_ "github.com/Katano-Sukune/xpcwallet/walletdb/bdb" // Required to register the boltdb walletdb implementation.
...
var (
	...
	addrPk, _       = xpcutil.NewAddressPubKey(pubKey.SerializeCompressed(),
		netParams)
...
func testFilterSingleBlock(node *rpctest.Harness, chainView FilteredChainView,
	...
	txns := []*xpcutil.Tx{xpcutil.NewTx(spendingTx1), xpcutil.NewTx(spendingTx2)}
