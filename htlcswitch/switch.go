...
func (s *Switch) htlcForwarder() {
	...
	var (
		...
		totalSatSent    xpcutil.Amount
		totalSatRecv    xpcutil.Amount
	)
	...
	for {
		...
		case <-s.cfg.LogEventTicker.Ticks():
			...
			var (
				...
				newSatSent    xpcutil.Amount
				newSatRecv    xpcutil.Amount
			)
			...
			var (
				...
				diffSatSent    xpcutil.Amount
				diffSatRecv    xpcutil.Amount
			)
