...
func createTestChannel(alicePrivKey, bobPrivKey []byte,
	aliceAmount, bobAmount, aliceReserve, bobReserve xpcutil.Amount,
...
func createClusterChannels(aliceToBob, bobToCarol xpcutil.Amount) (
...
func createTwoClusterChannels(aliceToBob, bobToCarol xpcutil.Amount) (
