...
`btcd`
------
Ensures that the [`github.com/Katano-Sukune/xpcd`][btcd] repository is checked out
locally. Lastly, installs the version of 
[`github.com/Katano-Sukune/xpcd`][btcd] specified in `Gopkg.toml`
...
`check`
-------
Installs the version of [`github.com/Katano-Sukune/xpcd`][btcd] specified
...
`itest`
-------
Installs the version of [`github.com/Katano-Sukune/xpcd`][btcd] specified in
...
[btcd]: https://github.com/Katano-Sukune/xpcd (github.com/Katano-Sukune/xpcd")
